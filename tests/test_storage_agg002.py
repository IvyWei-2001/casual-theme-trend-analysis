...
def test_fresh_schema_has_existing_columns_after_v9(tmp_path: Path) -> None:
...
def test_growth_current_coverage_accepts_partial_or_full_but_not_above_product_count(
    ...
    assert replace(growth, **{field_name: 1}).current_product_count == growth.current_product_count
